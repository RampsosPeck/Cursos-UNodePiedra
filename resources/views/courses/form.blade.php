					...
					<div class="card-body">
						...
						<div class="form-group ml-3 mr-2">
							<div class="col-md-6 offset-4">
								<input type="file"
									class="custom-file-input{{ $errors->has('picture') ? ' is-invalid' : '' }}" id="picture" name="picture" />
						...
						<div class="form-group row">
							...
							<div class="col-md-6">
								<textarea name="description" id="description" class="form-control{{ $errors->has('description') ? ' is-invalid' : ''  }}" required rows="6">{{ old('description') ? : $course->description }}</textarea>
				...
				<div class="card">
					...
					<div class="card-body">
						<div class="form-group row">
							...
							<div class="col-md-6">
								<input type="text" id="requirement1"
									class="form-control{{ $errors->has('requirements.0') ? ' is-invalid' : '' }}" name="requirements[]"
						...
						<div class="form-group row">
							...
							<div class="col-md-6">
								<input type="text" id="requirement1"
									class="form-control{{ $errors->has('requirements.1') ? ' is-invalid' : '' }}" name="requirements[]"
				...
				<div class="card">
					...
					<div class="card-body">
						<div class="form-group row">
							...
							<div class="col-md-6">
								<input type="text" id="goal1"
									class="form-control{{ $errors->has('goals.0') ? ' is-invalid' : '' }}" name="goals[]"
						...
						<div class="form-group row">
							...
							<div class="col-md-6">
								<input type="text" id="goal1"
									class="form-control{{ $errors->has('goals.1') ? ' is-invalid' : '' }}" name="goals[]"
