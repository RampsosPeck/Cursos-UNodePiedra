		...
		<div class="container-fluid">
			<form action="{{ route('courses.add_review') }}" method="POST" class="form-inline" id="rating_form">
				...
				<div class="form-group">
					<div class="col-12 ">
						<ul id="list_rating" class="list-inline" style="font-size: 10px;">
							<li class="list-inline-item start" data-number="1"><i class="fa fa-star yellow"></i></li>
							<li class="list-inline-item start" data-number="2"><i class="fa fa-star "></i></li>
							<li class="list-inline-item start" data-number="3"><i class="fa fa-star "></i></li>
							<li class="list-inline-item start" data-number="4"><i class="fa fa-star "></i></li>
							<li class="list-inline-item start" data-number="5"><i class="fa fa-star "></i></li>
						</ul>
					</div>
				</div>
				<br />
